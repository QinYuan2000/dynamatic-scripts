module {
  handshake.func @fir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: none, ...) -> i32 attributes {argNames = ["di", "idx", "start"], resNames = ["out0"]} {
    ...
    %6 = oehb [1] %5 {bb = 1 : ui32, name = #handshake.name<"oehb0">} : i11
    ...
    %11 = tehb [2] %13#1 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i1
    ...
    %26 = oehb [1] %12 {bb = 1 : ui32, name = #handshake.name<"oehb1">} : i32
    ...
    %30 = oehb [1] %29 {bb = 1 : ui32, name = #handshake.name<"oehb3">} : i12
    ...
    %35 = tehb [2] %34#1 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i1
    %trueResult_4, %falseResult_5 = cond_br %35, %28 {bb = 1 : ui32, name = #handshake.name<"cond_br2">} : i32
    %36 = oehb [1] %result {bb = 1 : ui32, name = #handshake.name<"oehb2">} : none
    ...
    %38 = oehb [1] %falseResult_5 {bb = 2 : ui32, name = #handshake.name<"oehb4">} : i32
    %39 = return {bb = 2 : ui32, name = #handshake.name<"return1">} %38 : i32
    end {bb = 2 : ui32, bufProps = #handshake<bufProps{"1": [0,0], [0,0], 0.000000e+00, 0.000000e+00, 0.000000e+00, "2": [0,0], [0,0], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, name = #handshake.name<"end0">} %39, %done, %done_1 : i32, none, none
  }
}
