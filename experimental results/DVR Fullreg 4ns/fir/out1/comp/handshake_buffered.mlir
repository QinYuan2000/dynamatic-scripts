module {
  handshake.func @fir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: none, ...) -> i32 attributes {argNames = ["di", "idx", "start"], resNames = ["out0"]} {
    ...
    %15 = tehb [2] %17#1 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i1
    ...
    %addressResult_2, %dataResult_3 = mc_load[%28] %memOutputs_0 {bb = 1 : ui32, bufProps = #handshake<bufProps{"1": [0,0], [0,0], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, name = #handshake.name<"mc_load1">} : i32, i32
    ...
    %39 = tehb [2] %38#1 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i1
    ...
    %42 = oehb [1] %falseResult_5 {bb = 2 : ui32, name = #handshake.name<"oehb4">} : i32
    %43 = merge %42 {bb = 2 : ui32, name = #handshake.name<"merge1">} : i32
    %44 = return {bb = 2 : ui32, name = #handshake.name<"return1">} %43 : i32
