module {
  handshake.func @fir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: none, ...) -> i32 attributes {argNames = ["di", "idx", "start"], resNames = ["out0"]} {
    ...
    %10 = tehb [3001] %9 {bb = 1 : ui32, name = #handshake.name<"tehb0">} : i11
    ...
    %15 = oehb [4002] %17#1 {bb = 1 : ui32, name = #handshake.name<"oehb2">} : i1
    ...
    %30 = oehb [1] %16 {bb = 1 : ui32, name = #handshake.name<"oehb0">} : i32
    %31 = tehb [1] %30 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : i32
    %32 = arith.addi %31, %29 {bb = 1 : ui32, name = #handshake.name<"addi0">} : i32
    %33 = arith.addi %12, %26 {bb = 1 : ui32, name = #handshake.name<"addi1">} : i12
    %34 = tehb [3001] %33 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i12
    ...
    %39 = oehb [4002] %38#1 {bb = 1 : ui32, name = #handshake.name<"oehb3">} : i1
    ...
    %41 = tehb [1] %40 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : none
