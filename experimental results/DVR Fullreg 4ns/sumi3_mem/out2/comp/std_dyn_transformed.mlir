module {
  ...
  ^bb1(%0: index, %1: i32):  // 2 preds: ^bb0, ^bb1
    %c1000 = arith.constant {name = #handshake.name<"constant4">} 1000 : index
    %c1 = arith.constant {name = #handshake.name<"constant5">} 1 : index
    %2 = memref.load %arg0[%0] {mem_interface = #handshake.mem_interface<MC>, name = #handshake.name<"load1">} : memref<1000xi32>
