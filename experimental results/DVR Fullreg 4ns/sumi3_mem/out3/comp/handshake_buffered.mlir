module {
  handshake.func @sumi3_mem(%arg0: memref<1000xi32>, %arg1: none, ...) -> i32 attributes {argNames = ["a", "start"], resNames = ["out0"]} {
    ...
    %13 = oehb [4003] %15#1 {bb = 1 : ui32, name = #handshake.name<"oehb2">} : i1
    ...
    %24 = oehb [4002] %22#0 {bb = 1 : ui32, name = #handshake.name<"oehb3">} : i32
    ...
    %30 = tehb [3001] %29 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i12
    %31:2 = fork [2] %30 {bb = 1 : ui32, name = #handshake.name<"fork5">} : i12
    %32 = tehb [3001] %31#0 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i12
    %33 = arith.trunci %32 {bb = 1 : ui32, name = #handshake.name<"trunci0">} : i12 to i11
    %34 = arith.cmpi ult, %31#1, %18 {bb = 1 : ui32, name = #handshake.name<"cmpi1">} : i12
    %35 = tehb [3001] %34 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : i1
    %36:3 = fork [3] %35 {bb = 1 : ui32, name = #handshake.name<"fork6">} : i1
    %trueResult, %falseResult = cond_br %36#0, %33 {bb = 1 : ui32, name = #handshake.name<"cond_br0">} : i11
    sink %falseResult {name = #handshake.name<"sink0">} : i11
    %37 = oehb [4003] %36#1 {bb = 1 : ui32, name = #handshake.name<"oehb4">} : i1
    %trueResult_0, %falseResult_1 = cond_br %37, %28 {bb = 1 : ui32, name = #handshake.name<"cond_br2">} : i32
    %38 = oehb [1] %result {bb = 1 : ui32, name = #handshake.name<"oehb1">} : none
    %39 = tehb [1] %38 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : none
    %trueResult_2, %falseResult_3 = cond_br %36#2, %39 {bb = 1 : ui32, name = #handshake.name<"cond_br3">} : none
    ...
    end {bb = 2 : ui32, name = #handshake.name<"end0">} %41, %done : i32, none
  }
}
