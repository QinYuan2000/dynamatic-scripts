module {
  handshake.func @sumi3_mem(%arg0: memref<1000xi32>, %arg1: none, ...) -> i32 attributes {argNames = ["a", "start"], resNames = ["out0"]} {
    ...
    %9 = oehb [4003] %11#1 {bb = 1 : ui32, name = #handshake.name<"oehb2">} : i1
    ...
    %20 = oehb [4002] %18#0 {bb = 1 : ui32, name = #handshake.name<"oehb3">} : i32
    ...
    %26 = tehb [3001] %25 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i12
    %27:2 = fork [2] %26 {bb = 1 : ui32, name = #handshake.name<"fork5">} : i12
    %28 = tehb [3001] %27#0 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i12
    %29 = arith.trunci %28 {bb = 1 : ui32, name = #handshake.name<"trunci0">} : i12 to i11
    %30 = arith.cmpi ult, %27#1, %14 {bb = 1 : ui32, name = #handshake.name<"cmpi1">} : i12
    %31 = tehb [3001] %30 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : i1
    %32:3 = fork [3] %31 {bb = 1 : ui32, name = #handshake.name<"fork6">} : i1
    %trueResult, %falseResult = cond_br %32#0, %29 {bb = 1 : ui32, name = #handshake.name<"cond_br0">} : i11
    sink %falseResult {name = #handshake.name<"sink0">} : i11
    %33 = oehb [4003] %32#1 {bb = 1 : ui32, name = #handshake.name<"oehb4">} : i1
    %trueResult_0, %falseResult_1 = cond_br %33, %24 {bb = 1 : ui32, name = #handshake.name<"cond_br2">} : i32
    %34 = oehb [1] %result {bb = 1 : ui32, name = #handshake.name<"oehb1">} : none
    %35 = tehb [1] %34 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : none
    %trueResult_2, %falseResult_3 = cond_br %32#2, %35 {bb = 1 : ui32, name = #handshake.name<"cond_br3">} : none
    sink %falseResult_3 {name = #handshake.name<"sink1">} : none
    %36 = return {bb = 2 : ui32, name = #handshake.name<"return1">} %falseResult_1 : i32
    end {bb = 2 : ui32, name = #handshake.name<"end0">} %36, %done : i32, none
  }
}
