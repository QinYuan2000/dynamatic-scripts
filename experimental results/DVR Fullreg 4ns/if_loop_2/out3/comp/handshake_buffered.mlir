module {
  handshake.func @if_loop_2(%arg0: memref<100xi32>, %arg1: i32, %arg2: none, ...) -> i32 attributes {argNames = ["a", "n", "start"], resNames = ["out0"]} {
    ...
    %11 = mux %20#2 [%48, %6] {bb = 1 : ui32, name = #handshake.name<"mux0">} : i1, i32
    %12 = tehb [3001] %11 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : i32
    %13:2 = fork [2] %12 {bb = 1 : ui32, name = #handshake.name<"fork2">} : i32
    %14 = oehb [1] %20#1 {bb = 1 : ui32, name = #handshake.name<"oehb0">} : i1
    %15 = tehb [1] %14 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i1
    %16 = mux %15 [%50, %8] {bb = 1 : ui32, name = #handshake.name<"mux1">} : i1, i32
    %17 = mux %20#0 [%51, %9] {bb = 1 : ui32, name = #handshake.name<"mux2">} : i1, i32
    %18 = tehb [3001] %17 {bb = 1 : ui32, name = #handshake.name<"tehb0">} : i32
    %19:2 = fork [2] %18 {bb = 1 : ui32, name = #handshake.name<"fork3">} : i32
    %result, %index = control_merge %52, %10 {bb = 1 : ui32, name = #handshake.name<"control_merge3">} : none, i1
    %20:3 = fork [3] %index {bb = 1 : ui32, name = #handshake.name<"fork4">} : i1
    %21 = arith.cmpi ult, %13#1, %19#1 {bb = 1 : ui32, name = #handshake.name<"cmpi1">} : i32
    %22:4 = fork [4] %21 {bb = 1 : ui32, name = #handshake.name<"fork5">} : i1
    %trueResult, %falseResult = cond_br %22#3, %19#0 {bb = 1 : ui32, name = #handshake.name<"cond_br1">} : i32
    sink %falseResult {name = #handshake.name<"sink0">} : i32
    %trueResult_0, %falseResult_1 = cond_br %22#2, %13#0 {bb = 1 : ui32, name = #handshake.name<"cond_br2">} : i32
    sink %falseResult_1 {name = #handshake.name<"sink1">} : i32
    %23 = tehb [3001] %22#1 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : i1
    %trueResult_2, %falseResult_3 = cond_br %23, %16 {bb = 1 : ui32, name = #handshake.name<"cond_br3">} : i32
    %24 = tehb [3001] %result {bb = 1 : ui32, name = #handshake.name<"tehb2">} : none
    %trueResult_4, %falseResult_5 = cond_br %22#0, %24 {bb = 1 : ui32, name = #handshake.name<"cond_br4">} : none
    ...
    %28 = tehb [3001] %trueResult_2 {bb = 2 : ui32, name = #handshake.name<"tehb5">} : i32
    ...
    %addressResult, %dataResult = mc_load[%27#1] %memOutputs {bb = 2 : ui32, name = #handshake.name<"mc_load0">} : i32, i32
    ...
    %42 = tehb [3001] %40#0 {bb = 2 : ui32, name = #handshake.name<"tehb7">} : i32
    %43 = tehb [3001] %41 {bb = 2 : ui32, name = #handshake.name<"tehb8">} : i1
    %44 = arith.select %43, %42, %39 {bb = 2 : ui32, name = #handshake.name<"select0">} : i32
    %45 = arith.addi %29, %44 {bb = 2 : ui32, name = #handshake.name<"addi1">} : i32
    %46 = tehb [3001] %27#0 {bb = 2 : ui32, name = #handshake.name<"tehb6">} : i32
    %47 = arith.addi %46, %33 {bb = 2 : ui32, name = #handshake.name<"addi0">} : i32
    %48 = br %47 {bb = 2 : ui32, name = #handshake.name<"br6">} : i32
    %49 = tehb [3001] %45 {bb = 2 : ui32, name = #handshake.name<"tehb9">} : i32
    %50 = br %49 {bb = 2 : ui32, name = #handshake.name<"br7">} : i32
    %51 = br %25 {bb = 2 : ui32, name = #handshake.name<"br8">} : i32
    %52 = br %30 {bb = 2 : ui32, name = #handshake.name<"br9">} : none
    %53 = merge %falseResult_3 {bb = 3 : ui32, name = #handshake.name<"merge5">} : i32
    %54 = return {bb = 3 : ui32, name = #handshake.name<"return1">} %53 : i32
    end {bb = 3 : ui32, name = #handshake.name<"end0">} %54, %done : i32, none
  }
}
