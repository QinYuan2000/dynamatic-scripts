module {
  handshake.func @iir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: i32, %arg3: i32, %arg4: none, ...) -> i32 attributes {argNames = ["y", "x", "a", "b", "start"], resNames = ["out0"]} {
    ...
    %19 = oehb [1] %29#3 {bb = 1 : ui32, name = #handshake.name<"oehb2">} : i1
    ...
    %30:2 = fork [2] %result {bb = 1 : ui32, name = #handshake.name<"fork6">} : none
    ...
    %39 = arith.muli %24#1, %20 {bb = 1 : ui32, name = #handshake.name<"muli0">} : i32
    %addressResult_2, %dataResult_3 = mc_load[%18#0] %memOutputs {bb = 1 : ui32, name = #handshake.name<"mc_load1">} : i32, i32
    %40 = arith.muli %28#1, %dataResult_3 {bb = 1 : ui32, name = #handshake.name<"muli1">} : i32
    %41 = arith.addi %39, %40 {bb = 1 : ui32, name = #handshake.name<"addi0">} : i32
    %42:2 = fork [2] %41 {bb = 1 : ui32, name = #handshake.name<"fork7">} : i32
    %43 = tehb [2005] %18#1 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i32
    %addressResult_4, %dataResult_5 = mc_store[%43] %42#1 {bb = 1 : ui32, name = #handshake.name<"mc_store0">} : i32, i32
    %44 = arith.addi %16, %38 {bb = 1 : ui32, name = #handshake.name<"addi2">} : i12
    %45 = oehb [1] %44 {bb = 1 : ui32, name = #handshake.name<"oehb4">} : i12
    ...
    %trueResult_6, %falseResult_7 = cond_br %50, %42#0 {bb = 1 : ui32, name = #handshake.name<"cond_br2">} : i32
    %trueResult_8, %falseResult_9 = cond_br %49#2, %24#0 {bb = 1 : ui32, name = #handshake.name<"cond_br3">} : i32
    sink %falseResult_9 {name = #handshake.name<"sink1">} : i32
    %trueResult_10, %falseResult_11 = cond_br %49#3, %28#0 {bb = 1 : ui32, name = #handshake.name<"cond_br4">} : i32
    sink %falseResult_11 {name = #handshake.name<"sink2">} : i32
    %51 = oehb [1] %30#1 {bb = 1 : ui32, name = #handshake.name<"oehb3">} : none
    %52 = tehb [4001] %51 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : none
