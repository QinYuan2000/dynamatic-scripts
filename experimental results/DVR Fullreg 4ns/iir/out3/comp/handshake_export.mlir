module {
  handshake.func @iir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: i32, %arg3: i32, %arg4: none, ...) -> i32 attributes {argNames = ["y", "x", "a", "b", "start"], resNames = ["out0"]} {
    ...
    %11 = tehb [3001] %19#3 {bb = 1 : ui32, name = #handshake.name<"tehb6">} : i1
    ...
    %33 = oehb [1] %10#1 {bb = 1 : ui32, name = #handshake.name<"oehb0">} : i32
    %34 = tehb [1] %33 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i32
    %addressResult_4, %dataResult_5 = mc_store[%34] %32#1 {bb = 1 : ui32, name = #handshake.name<"mc_store0">} : i32, i32
    %35 = arith.addi %8, %28 {bb = 1 : ui32, name = #handshake.name<"addi2">} : i12
    %36 = tehb [3001] %35 {bb = 1 : ui32, name = #handshake.name<"tehb8">} : i12
    ...
    %39 = arith.cmpi ult, %37#1, %25 {bb = 1 : ui32, name = #handshake.name<"cmpi1">} : i12
    ...
    %41 = tehb [3001] %40#1 {bb = 1 : ui32, name = #handshake.name<"tehb9">} : i1
    %trueResult_6, %falseResult_7 = cond_br %41, %32#0 {bb = 1 : ui32, name = #handshake.name<"cond_br2">} : i32
    %42 = tehb [3001] %15#0 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : i32
    ...
    %43 = tehb [3001] %18#0 {bb = 1 : ui32, name = #handshake.name<"tehb5">} : i32
    ...
    %44 = oehb [1] %20#1 {bb = 1 : ui32, name = #handshake.name<"oehb1">} : none
    %45 = tehb [1] %44 {bb = 1 : ui32, name = #handshake.name<"tehb7">} : none
    %trueResult_12, %falseResult_13 = cond_br %40#4, %45 {bb = 1 : ui32, name = #handshake.name<"cond_br5">} : none
