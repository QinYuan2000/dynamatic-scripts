module {
  handshake.func @iir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: i32, %arg3: i32, %arg4: none, ...) -> i32 attributes {argNames = ["y", "x", "a", "b", "start"], resNames = ["out0"]} {
    ...
    %19 = tehb [3001] %27#3 {bb = 1 : ui32, name = #handshake.name<"tehb6">} : i1
    ...
    %41 = oehb [1] %18#1 {bb = 1 : ui32, name = #handshake.name<"oehb0">} : i32
    %42 = tehb [1] %41 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i32
    %addressResult_4, %dataResult_5 = mc_store[%42] %40#1 {bb = 1 : ui32, name = #handshake.name<"mc_store0">} : i32, i32
    %43 = arith.addi %16, %36 {bb = 1 : ui32, name = #handshake.name<"addi2">} : i12
    %44 = tehb [3001] %43 {bb = 1 : ui32, name = #handshake.name<"tehb8">} : i12
    ...
    %47 = arith.cmpi ult, %45#1, %33 {bb = 1 : ui32, name = #handshake.name<"cmpi1">} : i12
    ...
    %49 = tehb [3001] %48#1 {bb = 1 : ui32, name = #handshake.name<"tehb9">} : i1
    %trueResult_6, %falseResult_7 = cond_br %49, %40#0 {bb = 1 : ui32, name = #handshake.name<"cond_br2">} : i32
    %50 = tehb [3001] %23#0 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : i32
    ...
    %51 = tehb [3001] %26#0 {bb = 1 : ui32, name = #handshake.name<"tehb5">} : i32
    ...
    %52 = oehb [1] %28#1 {bb = 1 : ui32, name = #handshake.name<"oehb1">} : none
    %53 = tehb [1] %52 {bb = 1 : ui32, name = #handshake.name<"tehb7">} : none
    %trueResult_12, %falseResult_13 = cond_br %48#4, %53 {bb = 1 : ui32, name = #handshake.name<"cond_br5">} : none
