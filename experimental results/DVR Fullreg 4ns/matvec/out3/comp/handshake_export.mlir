module {
  handshake.func @matvec(%arg0: memref<10000xi32>, %arg1: memref<100xi32>, %arg2: memref<100xi32>, %arg3: none, ...) -> i32 attributes {argNames = ["m", "v", "out", "start"], resNames = ["out0"]} {
    ...
    %13 = oehb [1] %12#0 {bb = 2 : ui32, name = #handshake.name<"oehb0">} : i8
    %14 = tehb [1] %13 {bb = 2 : ui32, name = #handshake.name<"tehb2">} : i8
    %15 = arith.extsi %14 {bb = 2 : ui32, name = #handshake.name<"extsi10">} : i8 to i17
    %16 = arith.extsi %12#1 {bb = 2 : ui32, name = #handshake.name<"extsi11">} : i8 to i9
    %17 = arith.extsi %12#2 {bb = 2 : ui32, name = #handshake.name<"extsi12">} : i8 to i32
    %18 = oehb [4003] %23#2 {bb = 2 : ui32, name = #handshake.name<"oehb4">} : i1
    ...
    %33 = tehb [3001] %17 {bb = 2 : ui32, name = #handshake.name<"tehb3">} : i32
    %addressResult, %dataResult = mc_load[%33] %memOutputs {bb = 2 : ui32, name = #handshake.name<"mc_load0">} : i32, i32
    %34 = arith.muli %22, %27 {bb = 2 : ui32, name = #handshake.name<"muli2">} : i16
    %35 = arith.extsi %34 {bb = 2 : ui32, name = #handshake.name<"extsi17">} : i16 to i17
    %36 = arith.addi %15, %35 {bb = 2 : ui32, name = #handshake.name<"addi4">} : i17
    ...
    %38 = tehb [3001] %dataResult {bb = 2 : ui32, name = #handshake.name<"tehb8">} : i32
    %39 = arith.muli %38, %dataResult_6 {bb = 2 : ui32, name = #handshake.name<"muli0">} : i32
    %40 = oehb [1] %19 {bb = 2 : ui32, name = #handshake.name<"oehb1">} : i32
    %41 = tehb [1] %40 {bb = 2 : ui32, name = #handshake.name<"tehb4">} : i32
    %42 = arith.addi %41, %39 {bb = 2 : ui32, name = #handshake.name<"addi0">} : i32
    %43 = arith.addi %16, %32 {bb = 2 : ui32, name = #handshake.name<"addi5">} : i9
    %44:2 = fork [2] %43 {bb = 2 : ui32, name = #handshake.name<"fork7">} : i9
    %45 = tehb [3001] %44#0 {bb = 2 : ui32, name = #handshake.name<"tehb9">} : i9
    ...
    %48 = tehb [3001] %47 {bb = 2 : ui32, name = #handshake.name<"tehb10">} : i1
    ...
    %50 = oehb [4003] %49#2 {bb = 2 : ui32, name = #handshake.name<"oehb5">} : i1
    %trueResult_7, %falseResult_8 = cond_br %50, %42 {bb = 2 : ui32, name = #handshake.name<"cond_br3">} : i32
    %51 = oehb [1] %21#0 {bb = 2 : ui32, name = #handshake.name<"oehb2">} : i8
    ...
    %53 = oehb [1] %result_3 {bb = 2 : ui32, name = #handshake.name<"oehb3">} : none
    ...
    %57 = tehb [3001] %55#1 {bb = 3 : ui32, name = #handshake.name<"tehb11">} : i8
    %58 = arith.extsi %57 {bb = 3 : ui32, name = #handshake.name<"extsi20">} : i8 to i32
    %59:2 = fork [2] %falseResult_8 {bb = 3 : ui32, name = #handshake.name<"fork10">} : i32
    %60:2 = fork [2] %falseResult_12 {bb = 3 : ui32, name = #handshake.name<"fork11">} : none
    ...
    %addressResult_13, %dataResult_14 = mc_store[%58] %59#1 {bb = 3 : ui32, name = #handshake.name<"mc_store0">} : i32, i32
    %69 = arith.addi %56, %68 {bb = 3 : ui32, name = #handshake.name<"addi6">} : i9
    %70:2 = fork [2] %69 {bb = 3 : ui32, name = #handshake.name<"fork12">} : i9
    %71 = tehb [3001] %70#0 {bb = 3 : ui32, name = #handshake.name<"tehb13">} : i9
    %72 = arith.trunci %71 {bb = 3 : ui32, name = #handshake.name<"trunci1">} : i9 to i8
    %73 = arith.cmpi ult, %70#1, %65 {bb = 3 : ui32, name = #handshake.name<"cmpi3">} : i9
    %74 = tehb [3001] %73 {bb = 3 : ui32, name = #handshake.name<"tehb14">} : i1
    %75:3 = fork [3] %74 {bb = 3 : ui32, name = #handshake.name<"fork13">} : i1
    %trueResult_15, %falseResult_16 = cond_br %75#0, %72 {bb = 3 : ui32, name = #handshake.name<"cond_br9">} : i8
    sink %falseResult_16 {name = #handshake.name<"sink1">} : i8
    %76 = tehb [3001] %60#0 {bb = 3 : ui32, name = #handshake.name<"tehb12">} : none
    %trueResult_17, %falseResult_18 = cond_br %75#1, %76 {bb = 3 : ui32, name = #handshake.name<"cond_br7">} : none
    sink %falseResult_18 {name = #handshake.name<"sink2">} : none
    %trueResult_19, %falseResult_20 = cond_br %75#2, %59#0 {bb = 3 : ui32, name = #handshake.name<"cond_br8">} : i32
