module {
  handshake.func @matvec(%arg0: memref<10000xi32>, %arg1: memref<100xi32>, %arg2: memref<100xi32>, %arg3: none, ...) -> i32 attributes {argNames = ["m", "v", "out", "start"], resNames = ["out0"]} {
    ...
    %20 = arith.extsi %19#0 {bb = 2 : ui32, name = #handshake.name<"extsi10">} : i8 to i17
    %21 = arith.extsi %19#1 {bb = 2 : ui32, name = #handshake.name<"extsi11">} : i8 to i9
    %22 = oehb [1] %19#2 {bb = 2 : ui32, name = #handshake.name<"oehb0">} : i8
    %23 = tehb [1] %22 {bb = 2 : ui32, name = #handshake.name<"tehb2">} : i8
    %24 = arith.extsi %23 {bb = 2 : ui32, name = #handshake.name<"extsi12">} : i8 to i32
    %25 = oehb [4003] %30#2 {bb = 2 : ui32, name = #handshake.name<"oehb5">} : i1
    ...
    %40 = arith.muli %29, %34 {bb = 2 : ui32, name = #handshake.name<"muli2">} : i16
    %41 = arith.extsi %40 {bb = 2 : ui32, name = #handshake.name<"extsi17">} : i16 to i17
    %42 = oehb [1] %20 {bb = 2 : ui32, name = #handshake.name<"oehb1">} : i17
    %43 = tehb [1] %42 {bb = 2 : ui32, name = #handshake.name<"tehb3">} : i17
    %44 = arith.addi %43, %41 {bb = 2 : ui32, name = #handshake.name<"addi4">} : i17
    ...
    %50 = arith.addi %21, %39 {bb = 2 : ui32, name = #handshake.name<"addi5">} : i9
    %51:2 = fork [2] %50 {bb = 2 : ui32, name = #handshake.name<"fork7">} : i9
    %52 = tehb [3001] %51#0 {bb = 2 : ui32, name = #handshake.name<"tehb8">} : i9
    ...
    %55 = tehb [3001] %54 {bb = 2 : ui32, name = #handshake.name<"tehb9">} : i1
    ...
    %57 = oehb [4003] %56#2 {bb = 2 : ui32, name = #handshake.name<"oehb6">} : i1
    %trueResult_7, %falseResult_8 = cond_br %57, %49 {bb = 2 : ui32, name = #handshake.name<"cond_br3">} : i32
    %58 = oehb [1] %28#0 {bb = 2 : ui32, name = #handshake.name<"oehb3">} : i8
    ...
    %60 = oehb [1] %result_3 {bb = 2 : ui32, name = #handshake.name<"oehb4">} : none
    ...
    %68 = tehb [3001] %falseResult_12 {bb = 3 : ui32, name = #handshake.name<"tehb10">} : none
    %69 = merge %68 {bb = 3 : ui32, name = #handshake.name<"merge5">} : none
    ...
    %79 = tehb [3001] %65 {bb = 3 : ui32, name = #handshake.name<"tehb11">} : i32
    %addressResult_13, %dataResult_14 = mc_store[%79] %67#1 {bb = 3 : ui32, name = #handshake.name<"mc_store0">} : i32, i32
    %80 = arith.addi %64, %78 {bb = 3 : ui32, name = #handshake.name<"addi6">} : i9
    %81:2 = fork [2] %80 {bb = 3 : ui32, name = #handshake.name<"fork12">} : i9
    %82 = tehb [3001] %81#0 {bb = 3 : ui32, name = #handshake.name<"tehb12">} : i9
    %83 = arith.trunci %82 {bb = 3 : ui32, name = #handshake.name<"trunci1">} : i9 to i8
    %84 = arith.cmpi ult, %81#1, %75 {bb = 3 : ui32, name = #handshake.name<"cmpi3">} : i9
    %85 = tehb [3001] %84 {bb = 3 : ui32, name = #handshake.name<"tehb13">} : i1
    %86:3 = fork [3] %85 {bb = 3 : ui32, name = #handshake.name<"fork13">} : i1
    %trueResult_15, %falseResult_16 = cond_br %86#0, %83 {bb = 3 : ui32, name = #handshake.name<"cond_br9">} : i8
    sink %falseResult_16 {name = #handshake.name<"sink1">} : i8
    %trueResult_17, %falseResult_18 = cond_br %86#1, %70#0 {bb = 3 : ui32, name = #handshake.name<"cond_br7">} : none
    sink %falseResult_18 {name = #handshake.name<"sink2">} : none
    %trueResult_19, %falseResult_20 = cond_br %86#2, %67#0 {bb = 3 : ui32, name = #handshake.name<"cond_br8">} : i32
