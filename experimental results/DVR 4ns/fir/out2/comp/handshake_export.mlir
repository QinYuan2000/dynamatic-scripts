module {
  handshake.func @fir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: none, ...) -> i32 attributes {argNames = ["di", "idx", "start"], resNames = ["out0"]} {
    ...
    %11 = tehb [2003] %13#1 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i1
    ...
    %35 = tehb [2003] %34#1 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : i1
    ...
    %37 = tehb [4001] %36 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : none
