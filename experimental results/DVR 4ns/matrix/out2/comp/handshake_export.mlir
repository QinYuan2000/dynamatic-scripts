module {
  handshake.func @matrix(%arg0: memref<900xi32>, %arg1: memref<900xi32>, %arg2: memref<900xi32>, %arg3: none, ...) -> none attributes {argNames = ["inA", "inB", "outC", "start"], resNames = ["out0"]} {
    ...
    %17 = mux %36#2 [%trueResult, %15] {bb = 3 : ui32, name = #handshake.name<"mux10">} : i1, i6
    ...
    %24 = tehb [2007] %36#3 {bb = 3 : ui32, name = #handshake.name<"tehb7">} : i1
    %25 = mux %24 [%trueResult_9, %23] {bb = 3 : ui32, name = #handshake.name<"mux4">} : i1, i32
    %26 = mux %36#0 [%trueResult_11, %10] {bb = 3 : ui32, name = #handshake.name<"mux11">} : i1, i6
    ...
    %30 = mux %36#1 [%trueResult_13, %9] {bb = 3 : ui32, name = #handshake.name<"mux12">} : i1, i6
    ...
    %34 = tehb [2003] %33#1 {bb = 3 : ui32, name = #handshake.name<"tehb5">} : i6
    ...
    %48 = tehb [2003] %20 {bb = 3 : ui32, name = #handshake.name<"tehb1">} : i13
    ...
    %51 = arith.muli %22, %42 {bb = 3 : ui32, name = #handshake.name<"muli5">} : i12
    ...
    %59 = arith.addi %21, %45 {bb = 3 : ui32, name = #handshake.name<"addi9">} : i7
    ...
    %63 = oehb [1] %62 {bb = 3 : ui32, name = #handshake.name<"oehb8">} : i1
    %64:5 = fork [5] %63 {bb = 3 : ui32, name = #handshake.name<"fork11">} : i1
    %65 = oehb [1] %61 {bb = 3 : ui32, name = #handshake.name<"oehb7">} : i6
    %trueResult, %falseResult = cond_br %64#0, %65 {bb = 3 : ui32, name = #handshake.name<"cond_br0">} : i6
    sink %falseResult {name = #handshake.name<"sink0">} : i6
    %66 = tehb [2007] %64#3 {bb = 3 : ui32, name = #handshake.name<"tehb8">} : i1
    ...
    %trueResult_11, %falseResult_12 = cond_br %64#1, %67 {bb = 3 : ui32, name = #handshake.name<"cond_br1">} : i6
    %trueResult_13, %falseResult_14 = cond_br %64#2, %33#0 {bb = 3 : ui32, name = #handshake.name<"cond_br2">} : i6
    %68 = oehb [1] %result_5 {bb = 3 : ui32, name = #handshake.name<"oehb6">} : none
    %69 = tehb [4001] %68 {bb = 3 : ui32, name = #handshake.name<"tehb6">} : none
    %trueResult_15, %falseResult_16 = cond_br %64#4, %69 {bb = 3 : ui32, name = #handshake.name<"cond_br7">} : none
    ...
    %73 = oehb [1] %72#0 {bb = 4 : ui32, name = #handshake.name<"oehb11">} : i6
    ...
    %76 = oehb [1] %falseResult_16 {bb = 4 : ui32, name = #handshake.name<"oehb9">} : none
    ...
    %93:2 = fork [2] %92 {bb = 4 : ui32, name = #handshake.name<"fork16">} : i7
    %94 = arith.trunci %93#0 {bb = 4 : ui32, name = #handshake.name<"trunci1">} : i7 to i6
    %95 = arith.cmpi ult, %93#1, %84 {bb = 4 : ui32, name = #handshake.name<"cmpi4">} : i7
    %96 = oehb [1] %95 {bb = 4 : ui32, name = #handshake.name<"oehb13">} : i1
    %97:3 = fork [3] %96 {bb = 4 : ui32, name = #handshake.name<"fork17">} : i1
    %98 = oehb [1] %94 {bb = 4 : ui32, name = #handshake.name<"oehb12">} : i6
    %trueResult_19, %falseResult_20 = cond_br %97#0, %98 {bb = 4 : ui32, name = #handshake.name<"cond_br13">} : i6
    sink %falseResult_20 {name = #handshake.name<"sink1">} : i6
    %99 = oehb [1] %70#0 {bb = 4 : ui32, name = #handshake.name<"oehb10">} : i6
    %trueResult_21, %falseResult_22 = cond_br %97#1, %99 {bb = 4 : ui32, name = #handshake.name<"cond_br14">} : i6
