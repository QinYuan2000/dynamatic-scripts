module {
  handshake.func @matrix(%arg0: memref<900xi32>, %arg1: memref<900xi32>, %arg2: memref<900xi32>, %arg3: none, ...) -> none attributes {argNames = ["inA", "inB", "outC", "start"], resNames = ["out0"]} {
    ...
    %28 = mux %47#2 [%trueResult, %22] {bb = 3 : ui32, name = #handshake.name<"mux10">} : i1, i6
    ...
    %35 = tehb [2007] %47#3 {bb = 3 : ui32, name = #handshake.name<"tehb7">} : i1
    %36 = mux %35 [%trueResult_9, %34] {bb = 3 : ui32, name = #handshake.name<"mux4">} : i1, i32
    %37 = mux %47#0 [%trueResult_11, %25] {bb = 3 : ui32, name = #handshake.name<"mux11">} : i1, i6
    ...
    %41 = mux %47#1 [%trueResult_13, %26] {bb = 3 : ui32, name = #handshake.name<"mux12">} : i1, i6
    ...
    %45 = tehb [2003] %44#1 {bb = 3 : ui32, name = #handshake.name<"tehb5">} : i6
    ...
    %59 = tehb [2003] %31 {bb = 3 : ui32, name = #handshake.name<"tehb1">} : i13
    ...
    %62 = arith.muli %33, %53 {bb = 3 : ui32, name = #handshake.name<"muli5">} : i12
    ...
    %70 = arith.addi %32, %56 {bb = 3 : ui32, name = #handshake.name<"addi9">} : i7
    ...
    %74 = oehb [1] %73 {bb = 3 : ui32, name = #handshake.name<"oehb8">} : i1
    %75:5 = fork [5] %74 {bb = 3 : ui32, name = #handshake.name<"fork11">} : i1
    %76 = oehb [1] %72 {bb = 3 : ui32, name = #handshake.name<"oehb7">} : i6
    %trueResult, %falseResult = cond_br %75#0, %76 {bb = 3 : ui32, name = #handshake.name<"cond_br0">} : i6
    sink %falseResult {name = #handshake.name<"sink0">} : i6
    %77 = tehb [2007] %75#3 {bb = 3 : ui32, name = #handshake.name<"tehb8">} : i1
    ...
    %trueResult_11, %falseResult_12 = cond_br %75#1, %78 {bb = 3 : ui32, name = #handshake.name<"cond_br1">} : i6
    %trueResult_13, %falseResult_14 = cond_br %75#2, %44#0 {bb = 3 : ui32, name = #handshake.name<"cond_br2">} : i6
    %79 = oehb [1] %result_5 {bb = 3 : ui32, name = #handshake.name<"oehb6">} : none
    %80 = tehb [4001] %79 {bb = 3 : ui32, name = #handshake.name<"tehb6">} : none
    %trueResult_15, %falseResult_16 = cond_br %75#4, %80 {bb = 3 : ui32, name = #handshake.name<"cond_br7">} : none
    ...
    %86 = oehb [1] %85#0 {bb = 4 : ui32, name = #handshake.name<"oehb11">} : i6
    ...
    %90 = oehb [1] %falseResult_16 {bb = 4 : ui32, name = #handshake.name<"oehb9">} : none
    ...
    %108:2 = fork [2] %107 {bb = 4 : ui32, name = #handshake.name<"fork16">} : i7
    %109 = arith.trunci %108#0 {bb = 4 : ui32, name = #handshake.name<"trunci1">} : i7 to i6
    %110 = arith.cmpi ult, %108#1, %99 {bb = 4 : ui32, name = #handshake.name<"cmpi4">} : i7
    %111 = oehb [1] %110 {bb = 4 : ui32, name = #handshake.name<"oehb13">} : i1
    %112:3 = fork [3] %111 {bb = 4 : ui32, name = #handshake.name<"fork17">} : i1
    %113 = oehb [1] %109 {bb = 4 : ui32, name = #handshake.name<"oehb12">} : i6
    %trueResult_19, %falseResult_20 = cond_br %112#0, %113 {bb = 4 : ui32, name = #handshake.name<"cond_br13">} : i6
    sink %falseResult_20 {name = #handshake.name<"sink1">} : i6
    %114 = oehb [1] %82#0 {bb = 4 : ui32, name = #handshake.name<"oehb10">} : i6
    %trueResult_21, %falseResult_22 = cond_br %112#1, %114 {bb = 4 : ui32, name = #handshake.name<"cond_br14">} : i6
