module {
  ...
  ^bb2(%1: index):  // 2 preds: ^bb1, ^bb2
    ...
    %4 = memref.load %arg2[%3] {deps = #handshake<deps[<"store6" (3) [[0, 0], [0, 0]]>]>, name = #handshake.name<"load6">} : memref<900xi32>
    ...
    memref.store %7, %arg2[%9] {name = #handshake.name<"store6">} : memref<900xi32>
    %10 = arith.muli %0, %c30 {name = #handshake.name<"muli5">} : index
    %11 = arith.addi %1, %10 {name = #handshake.name<"addi2">} : index
    %12 = memref.load %arg4[%11] {deps = #handshake<deps[<"store7" (3) [[0, 0], [0, 0]]>]>, name = #handshake.name<"load7">} : memref<900xi32>
    ...
    memref.store %15, %arg4[%17] {name = #handshake.name<"store7">} : memref<900xi32>
    %18 = arith.muli %0, %c30 {name = #handshake.name<"muli7">} : index
    %19 = arith.addi %1, %18 {name = #handshake.name<"addi4">} : index
    %20 = memref.load %arg3[%19] {deps = #handshake<deps[<"store8" (3) [[0, 0], [0, 0]]>]>, name = #handshake.name<"load8">} : memref<900xi32>
    ...
    memref.store %23, %arg3[%25] {name = #handshake.name<"store8">} : memref<900xi32>
  ...
  ^bb3:  // pred: ^bb2
    %28 = arith.addi %0, %c1 {name = #handshake.name<"addi7">} : index
    %29 = arith.cmpi ult, %28, %c30 {name = #handshake.name<"cmpi1">} : index
