module {
  handshake.func @if_loop_1(%arg0: memref<100xi32>, %arg1: i32, %arg2: none, ...) -> i32 attributes {argNames = ["a", "n", "start"], resNames = ["out0"]} {
    ...
    %7 = tehb [2003] %11#1 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : i1
    %8 = mux %7 [%44, %4] {bb = 1 : ui32, name = #handshake.name<"mux1">} : i1, i32
    %9 = mux %11#0 [%17, %arg1] {bb = 1 : ui32, name = #handshake.name<"mux2">} : i1, i32
    ...
    %14 = oehb [1] %8 {bb = 1 : ui32, name = #handshake.name<"oehb0">} : i32
    %15 = tehb [4001] %14 {bb = 1 : ui32, name = #handshake.name<"tehb0">} : i32
    %16 = tehb [2005] %13#1 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i1
    %trueResult_2, %falseResult_3 = cond_br %16, %15 {bb = 1 : ui32, name = #handshake.name<"cond_br3">} : i32
    ...
    %17 = tehb [4001] %trueResult {bb = 2 : ui32, name = #handshake.name<"tehb3">} : i32
    %18 = oehb [1] %trueResult_0 {bb = 2 : ui32, name = #handshake.name<"oehb1">} : i32
    %19:2 = fork [2] %18 {bb = 2 : ui32, name = #handshake.name<"fork6">} : i32
    %20 = tehb [4001] %trueResult_4 {bb = 2 : ui32, name = #handshake.name<"tehb4">} : none
    ...
    %34 = oehb [1] %33#1 {bb = 2 : ui32, name = #handshake.name<"oehb2">} : i32
    %35 = arith.shli %34, %32 {bb = 2 : ui32, name = #handshake.name<"shli0">} : i32
    %36 = oehb [1] %33#0 {bb = 2 : ui32, name = #handshake.name<"oehb3">} : i32
    %37 = oehb [1] %35 {bb = 2 : ui32, name = #handshake.name<"oehb4">} : i32
    ...
    %43 = oehb [1] %42 {bb = 2 : ui32, name = #handshake.name<"oehb6">} : i32
    %44 = arith.addi %trueResult_2, %43 {bb = 2 : ui32, name = #handshake.name<"addi1">} : i32
    %45 = arith.addi %19#0, %23 {bb = 2 : ui32, name = #handshake.name<"addi0">} : i32
    %46 = tehb [4001] %45 {bb = 2 : ui32, name = #handshake.name<"tehb5">} : i32
