module {
  handshake.func @if_loop_1(%arg0: memref<100xi32>, %arg1: i32, %arg2: none, ...) -> i32 attributes {argNames = ["a", "n", "start"], resNames = ["out0"]} {
    ...
    %13 = tehb [2003] %17#1 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : i1
    ...
    %20 = oehb [1] %14 {bb = 1 : ui32, name = #handshake.name<"oehb0">} : i32
    %21 = tehb [4001] %20 {bb = 1 : ui32, name = #handshake.name<"tehb0">} : i32
    %22 = tehb [2005] %19#1 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i1
    %trueResult_2, %falseResult_3 = cond_br %22, %21 {bb = 1 : ui32, name = #handshake.name<"cond_br3">} : i32
    ...
    %23 = tehb [4001] %trueResult {bb = 2 : ui32, name = #handshake.name<"tehb3">} : i32
    %24 = merge %23 {bb = 2 : ui32, name = #handshake.name<"merge2">} : i32
    %25 = oehb [1] %trueResult_0 {bb = 2 : ui32, name = #handshake.name<"oehb1">} : i32
    %26 = merge %25 {bb = 2 : ui32, name = #handshake.name<"merge3">} : i32
    %27:2 = fork [2] %26 {bb = 2 : ui32, name = #handshake.name<"fork6">} : i32
    %28 = merge %trueResult_2 {bb = 2 : ui32, name = #handshake.name<"merge4">} : i32
    %29 = tehb [4001] %trueResult_4 {bb = 2 : ui32, name = #handshake.name<"tehb4">} : none
    ...
    %43:2 = fork [2] %dataResult {bb = 2 : ui32, name = #handshake.name<"fork7">} : i32
    %44 = oehb [1] %43#1 {bb = 2 : ui32, name = #handshake.name<"oehb2">} : i32
    %45 = arith.shli %44, %42 {bb = 2 : ui32, name = #handshake.name<"shli0">} : i32
    %46 = oehb [1] %43#0 {bb = 2 : ui32, name = #handshake.name<"oehb3">} : i32
    %47 = oehb [1] %45 {bb = 2 : ui32, name = #handshake.name<"oehb4">} : i32
    ...
    %53 = oehb [1] %52 {bb = 2 : ui32, name = #handshake.name<"oehb6">} : i32
    %54 = arith.addi %28, %53 {bb = 2 : ui32, name = #handshake.name<"addi1">} : i32
    %55 = arith.addi %27#0, %33 {bb = 2 : ui32, name = #handshake.name<"addi0">} : i32
    %56 = tehb [4001] %55 {bb = 2 : ui32, name = #handshake.name<"tehb5">} : i32
    %57 = br %56 {bb = 2 : ui32, name = #handshake.name<"br6">} : i32
    %58 = br %54 {bb = 2 : ui32, name = #handshake.name<"br7">} : i32
    %59 = br %24 {bb = 2 : ui32, name = #handshake.name<"br8">} : i32
