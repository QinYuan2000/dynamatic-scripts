module {
  handshake.func @if_loop_1(%arg0: memref<100xi32>, %arg1: i32, %arg2: none, ...) -> i32 attributes {argNames = ["a", "n", "start"], resNames = ["out0"]} {
    ...
    %11 = mux %17#2 [%58, %6] {bb = 1 : ui32, name = #handshake.name<"mux0">} : i1, i32
    %12:2 = fork [2] %11 {bb = 1 : ui32, name = #handshake.name<"fork2">} : i32
    %13 = oehb [4002] %17#1 {bb = 1 : ui32, name = #handshake.name<"oehb0">} : i1
    %14 = mux %13 [%59, %8] {bb = 1 : ui32, name = #handshake.name<"mux1">} : i1, i32
    %15 = mux %17#0 [%60, %9] {bb = 1 : ui32, name = #handshake.name<"mux2">} : i1, i32
    %16:2 = fork [2] %15 {bb = 1 : ui32, name = #handshake.name<"fork3">} : i32
    %result, %index = control_merge %61, %10 {bb = 1 : ui32, name = #handshake.name<"control_merge3">} : none, i1
    ...
    %20 = oehb [4002] %19#1 {bb = 1 : ui32, name = #handshake.name<"oehb1">} : i1
    ...
    %21 = tehb [3001] %trueResult {bb = 2 : ui32, name = #handshake.name<"tehb0">} : i32
    ...
    %28 = tehb [3001] %trueResult_4 {bb = 2 : ui32, name = #handshake.name<"tehb2">} : none
    ...
    %44 = oehb [1] %42#0 {bb = 2 : ui32, name = #handshake.name<"oehb3">} : i32
    %45 = tehb [1] %44 {bb = 2 : ui32, name = #handshake.name<"tehb3">} : i32
    %46 = oehb [1] %43 {bb = 2 : ui32, name = #handshake.name<"oehb4">} : i32
    %47 = tehb [1] %46 {bb = 2 : ui32, name = #handshake.name<"tehb4">} : i32
    %48 = arith.addi %45, %47 {bb = 2 : ui32, name = #handshake.name<"addi2">} : i32
    %49:2 = fork [2] %48 {bb = 2 : ui32, name = #handshake.name<"fork8">} : i32
    %50 = arith.cmpi sgt, %49#1, %35 {bb = 2 : ui32, name = #handshake.name<"cmpi0">} : i32
    %51 = arith.select %50, %49#0, %38 {bb = 2 : ui32, name = #handshake.name<"select0">} : i32
    %52 = oehb [1] %51 {bb = 2 : ui32, name = #handshake.name<"oehb5">} : i32
    %53 = tehb [1] %52 {bb = 2 : ui32, name = #handshake.name<"tehb5">} : i32
    %54 = arith.addi %27, %53 {bb = 2 : ui32, name = #handshake.name<"addi1">} : i32
    %55 = arith.addi %24#0, %32 {bb = 2 : ui32, name = #handshake.name<"addi0">} : i32
    %56 = oehb [1] %55 {bb = 2 : ui32, name = #handshake.name<"oehb6">} : i32
    %57 = tehb [1] %56 {bb = 2 : ui32, name = #handshake.name<"tehb6">} : i32
    %58 = br %57 {bb = 2 : ui32, name = #handshake.name<"br6">} : i32
    %59 = br %54 {bb = 2 : ui32, name = #handshake.name<"br7">} : i32
    %60 = br %22 {bb = 2 : ui32, name = #handshake.name<"br8">} : i32
    %61 = br %29 {bb = 2 : ui32, name = #handshake.name<"br9">} : none
    %62 = merge %falseResult_3 {bb = 3 : ui32, name = #handshake.name<"merge5">} : i32
    %63 = return {bb = 3 : ui32, name = #handshake.name<"return1">} %62 : i32
    end {bb = 3 : ui32, name = #handshake.name<"end0">} %63, %done : i32, none
  }
}
