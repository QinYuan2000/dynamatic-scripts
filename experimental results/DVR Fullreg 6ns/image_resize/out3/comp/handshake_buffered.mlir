module {
  handshake.func @image_resize(%arg0: memref<900xi32>, %arg1: i32, %arg2: none, ...) -> none attributes {argNames = ["a", "c", "start"], resNames = ["out0"]} {
    %memOutputs, %done = mem_controller[%arg0 : memref<900xi32>] (%36, %addressResult, %addressResult_2, %dataResult_3) {connectedBlocks = [2 : i32], name = #handshake.name<"mem_controller0">} : (i32, i32, i32, i32) -> (i32, none)
    ...
    %34:2 = fork [2] %result_0 {bb = 2 : ui32, name = #handshake.name<"fork7">} : none
    %35 = constant %34#1 {bb = 2 : ui32, name = #handshake.name<"constant2">, value = 1 : i2} : i2
    %36 = arith.extsi %35 {bb = 2 : ui32, name = #handshake.name<"extsi2">} : i2 to i32
    %37 = source {bb = 2 : ui32, name = #handshake.name<"source0">}
    %38 = constant %37 {bb = 2 : ui32, name = #handshake.name<"constant8">, value = 30 : i6} : i6
    %39:3 = fork [3] %38 {bb = 2 : ui32, name = #handshake.name<"fork8">} : i6
    %40 = arith.extsi %39#0 {bb = 2 : ui32, name = #handshake.name<"extsi14">} : i6 to i12
    %41 = arith.extsi %39#1 {bb = 2 : ui32, name = #handshake.name<"extsi15">} : i6 to i12
    %42 = oehb [1] %39#2 {bb = 2 : ui32, name = #handshake.name<"oehb7">} : i6
    %43 = tehb [1] %42 {bb = 2 : ui32, name = #handshake.name<"tehb4">} : i6
    %44 = arith.extsi %43 {bb = 2 : ui32, name = #handshake.name<"extsi16">} : i6 to i7
    ...
    %48 = arith.muli %32, %41 {bb = 2 : ui32, name = #handshake.name<"muli2">} : i12
    ...
    %55 = arith.muli %31, %40 {bb = 2 : ui32, name = #handshake.name<"muli3">} : i12
    ...
    %65 = arith.cmpi ult, %63#1, %44 {bb = 2 : ui32, name = #handshake.name<"cmpi2">} : i7
    ...
    %67 = oehb [1] %30#0 {bb = 2 : ui32, name = #handshake.name<"oehb5">} : i6
    %68 = tehb [1] %67 {bb = 2 : ui32, name = #handshake.name<"tehb2">} : i6
    %trueResult_6, %falseResult_7 = cond_br %66#1, %68 {bb = 2 : ui32, name = #handshake.name<"cond_br1">} : i6
    %69 = oehb [1] %34#0 {bb = 2 : ui32, name = #handshake.name<"oehb6">} : none
    %70 = tehb [1] %69 {bb = 2 : ui32, name = #handshake.name<"tehb3">} : none
    %trueResult_8, %falseResult_9 = cond_br %66#3, %70 {bb = 2 : ui32, name = #handshake.name<"cond_br5">} : none
