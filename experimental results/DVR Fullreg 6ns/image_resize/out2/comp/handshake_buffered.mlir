module {
  handshake.func @image_resize(%arg0: memref<900xi32>, %arg1: i32, %arg2: none, ...) -> none attributes {argNames = ["a", "c", "start"], resNames = ["out0"]} {
    %memOutputs, %done = mem_controller[%arg0 : memref<900xi32>] (%41, %addressResult, %addressResult_2, %dataResult_3) {connectedBlocks = [2 : i32], name = #handshake.name<"mem_controller0">} : (i32, i32, i32, i32) -> (i32, none)
    ...
    %37 = oehb [1] %result_0 {bb = 2 : ui32, name = #handshake.name<"oehb3">} : none
    %38 = tehb [1] %37 {bb = 2 : ui32, name = #handshake.name<"tehb6">} : none
    %39:2 = fork [2] %38 {bb = 2 : ui32, name = #handshake.name<"fork7">} : none
    %40 = constant %39#1 {bb = 2 : ui32, name = #handshake.name<"constant2">, value = 1 : i2} : i2
    %41 = arith.extsi %40 {bb = 2 : ui32, name = #handshake.name<"extsi2">} : i2 to i32
    %42 = source {bb = 2 : ui32, name = #handshake.name<"source0">}
    %43 = constant %42 {bb = 2 : ui32, name = #handshake.name<"constant8">, value = 30 : i6} : i6
    %44:3 = fork [3] %43 {bb = 2 : ui32, name = #handshake.name<"fork8">} : i6
    %45 = arith.extsi %44#0 {bb = 2 : ui32, name = #handshake.name<"extsi14">} : i6 to i12
    %46 = arith.extsi %44#1 {bb = 2 : ui32, name = #handshake.name<"extsi15">} : i6 to i12
    %47 = arith.extsi %44#2 {bb = 2 : ui32, name = #handshake.name<"extsi16">} : i6 to i7
    %48 = source {bb = 2 : ui32, name = #handshake.name<"source1">}
    %49 = constant %48 {bb = 2 : ui32, name = #handshake.name<"constant9">, value = 1 : i2} : i2
    %50 = arith.extsi %49 {bb = 2 : ui32, name = #handshake.name<"extsi17">} : i2 to i7
    %51 = arith.muli %35, %46 {bb = 2 : ui32, name = #handshake.name<"muli2">} : i12
    %52 = arith.extsi %51 {bb = 2 : ui32, name = #handshake.name<"extsi18">} : i12 to i13
    %53 = arith.addi %24, %52 {bb = 2 : ui32, name = #handshake.name<"addi4">} : i13
    ...
    %55 = tehb [2005] %29#1 {bb = 2 : ui32, name = #handshake.name<"tehb4">} : i32
    %56 = arith.subi %55, %dataResult {bb = 2 : ui32, name = #handshake.name<"subi0">} : i32
    %57 = arith.muli %34, %45 {bb = 2 : ui32, name = #handshake.name<"muli3">} : i12
    %58 = arith.extsi %57 {bb = 2 : ui32, name = #handshake.name<"extsi20">} : i12 to i13
    %59 = tehb [2004] %22 {bb = 2 : ui32, name = #handshake.name<"tehb2">} : i13
    %60 = arith.addi %59, %58 {bb = 2 : ui32, name = #handshake.name<"addi5">} : i13
    %61 = oehb [1] %60 {bb = 2 : ui32, name = #handshake.name<"oehb4">} : i13
    %62 = arith.extsi %61 {bb = 2 : ui32, name = #handshake.name<"extsi21">} : i13 to i32
    %addressResult_2, %dataResult_3 = mc_store[%62] %56 {bb = 2 : ui32, mem_interface = #handshake.mem_interface<MC>, name = #handshake.name<"mc_store0">} : i32, i32
    %63 = arith.addi %25, %50 {bb = 2 : ui32, name = #handshake.name<"addi6">} : i7
    %64:2 = fork [2] %63 {bb = 2 : ui32, name = #handshake.name<"fork9">} : i7
    %65 = arith.trunci %64#0 {bb = 2 : ui32, name = #handshake.name<"trunci0">} : i7 to i6
    %66 = arith.cmpi ult, %64#1, %47 {bb = 2 : ui32, name = #handshake.name<"cmpi2">} : i7
    %67:4 = fork [4] %66 {bb = 2 : ui32, name = #handshake.name<"fork10">} : i1
    %trueResult, %falseResult = cond_br %67#0, %65 {bb = 2 : ui32, name = #handshake.name<"cond_br0">} : i6
    sink %falseResult {name = #handshake.name<"sink0">} : i6
    %trueResult_4, %falseResult_5 = cond_br %67#2, %29#0 {bb = 2 : ui32, name = #handshake.name<"cond_br3">} : i32
    %trueResult_6, %falseResult_7 = cond_br %67#1, %33#0 {bb = 2 : ui32, name = #handshake.name<"cond_br1">} : i6
    %trueResult_8, %falseResult_9 = cond_br %67#3, %39#0 {bb = 2 : ui32, name = #handshake.name<"cond_br5">} : none
    %68 = oehb [1] %falseResult_5 {bb = 3 : ui32, name = #handshake.name<"oehb5">} : i32
    ...
    %72 = oehb [1] %falseResult_9 {bb = 3 : ui32, name = #handshake.name<"oehb6">} : none
    ...
    %81 = oehb [1] %80 {bb = 3 : ui32, name = #handshake.name<"oehb7">} : i7
