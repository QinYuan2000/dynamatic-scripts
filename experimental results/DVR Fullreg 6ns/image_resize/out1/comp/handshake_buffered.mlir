module {
  handshake.func @image_resize(%arg0: memref<900xi32>, %arg1: i32, %arg2: none, ...) -> none attributes {argNames = ["a", "c", "start"], resNames = ["out0"]} {
    ...
    %23 = mux %33#2 [%trueResult_4, %15] {bb = 2 : ui32, name = #handshake.name<"mux3">} : i1, i32
    %24 = oehb [1] %23 {bb = 2 : ui32, name = #handshake.name<"oehb0">} : i32
    %25 = tehb [1] %24 {bb = 2 : ui32, name = #handshake.name<"tehb2">} : i32
    %26:2 = fork [2] %25 {bb = 2 : ui32, name = #handshake.name<"fork4">} : i32
    %27 = mux %33#0 [%trueResult_6, %16] {bb = 2 : ui32, name = #handshake.name<"mux7">} : i1, i6
    %28 = oehb [1] %27 {bb = 2 : ui32, name = #handshake.name<"oehb1">} : i6
    %29 = tehb [1] %28 {bb = 2 : ui32, name = #handshake.name<"tehb4">} : i6
    ...
    %34 = oehb [1] %result_0 {bb = 2 : ui32, name = #handshake.name<"oehb2">} : none
    %35 = tehb [1] %34 {bb = 2 : ui32, name = #handshake.name<"tehb5">} : none
    ...
    %50 = tehb [5] %21 {bb = 2 : ui32, name = #handshake.name<"tehb1">} : i13
    ...
    %addressResult, %dataResult = mc_load[%52] %memOutputs {bb = 2 : ui32, bufProps = #handshake<bufProps{"1": [0,0], [0,0], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, deps = #handshake<deps[<"mc_store0" (3) [[0, 0], [0, 0]]>]>, mem_interface = #handshake.mem_interface<MC>, name = #handshake.name<"mc_load0">} : i32, i32
    %53 = tehb [5] %26#1 {bb = 2 : ui32, name = #handshake.name<"tehb3">} : i32
    ...
    %57 = tehb [5] %20 {bb = 2 : ui32, name = #handshake.name<"tehb0">} : i13
    ...
    %60 = tehb [1] %59 {bb = 2 : ui32, name = #handshake.name<"tehb6">} : i32
    ...
    %61 = arith.addi %22, %47 {bb = 2 : ui32, name = #handshake.name<"addi6">} : i7
    %62 = oehb [1] %61 {bb = 2 : ui32, name = #handshake.name<"oehb3">} : i7
    %63 = tehb [1] %62 {bb = 2 : ui32, name = #handshake.name<"tehb7">} : i7
    %64:2 = fork [2] %63 {bb = 2 : ui32, name = #handshake.name<"fork9">} : i7
    %65 = arith.trunci %64#0 {bb = 2 : ui32, name = #handshake.name<"trunci0">} : i7 to i6
    %66 = arith.cmpi ult, %64#1, %44 {bb = 2 : ui32, name = #handshake.name<"cmpi2">} : i7
    ...
    %trueResult_4, %falseResult_5 = cond_br %67#2, %26#0 {bb = 2 : ui32, name = #handshake.name<"cond_br3">} : i32
    %trueResult_6, %falseResult_7 = cond_br %67#1, %30#0 {bb = 2 : ui32, name = #handshake.name<"cond_br1">} : i6
    %trueResult_8, %falseResult_9 = cond_br %67#3, %36#0 {bb = 2 : ui32, name = #handshake.name<"cond_br5">} : none
    %68 = merge %falseResult_5 {bb = 3 : ui32, name = #handshake.name<"merge2">} : i32
    ...
    %71 = oehb [1] %falseResult_9 {bb = 3 : ui32, name = #handshake.name<"oehb4">} : none
    ...
    %84:3 = fork [3] %83 {bb = 3 : ui32, name = #handshake.name<"fork12">} : i1
    %trueResult_10, %falseResult_11 = cond_br %84#0, %82 {bb = 3 : ui32, name = #handshake.name<"cond_br9">} : i6
    sink %falseResult_11 {name = #handshake.name<"sink1">} : i6
    %85 = oehb [1] %68 {bb = 3 : ui32, name = #handshake.name<"oehb5">} : i32
    %trueResult_12, %falseResult_13 = cond_br %84#1, %85 {bb = 3 : ui32, name = #handshake.name<"cond_br7">} : i32
    sink %falseResult_13 {name = #handshake.name<"sink2">} : i32
    %trueResult_14, %falseResult_15 = cond_br %84#2, %72 {bb = 3 : ui32, name = #handshake.name<"cond_br8">} : none
    %86 = merge %falseResult_15 {bb = 4 : ui32, name = #handshake.name<"merge6">} : none
    %87 = return {bb = 4 : ui32, name = #handshake.name<"return1">} %86 : none
    end {bb = 4 : ui32, bufProps = #handshake<bufProps{"1": [0,0], [0,0], 0.000000e+00, 0.000000e+00, 0.000000e+00}>, name = #handshake.name<"end1">} %87, %done : none, none
  }
}
