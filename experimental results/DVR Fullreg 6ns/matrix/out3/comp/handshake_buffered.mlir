module {
  handshake.func @matrix(%arg0: memref<900xi32>, %arg1: memref<900xi32>, %arg2: memref<900xi32>, %arg3: none, ...) -> none attributes {argNames = ["inA", "inB", "outC", "start"], resNames = ["out0"]} {
    ...
    %30 = mux %46#2 [%trueResult, %21] {bb = 3 : ui32, name = #handshake.name<"mux10">} : i1, i6
    %31:3 = fork [3] %30 {bb = 3 : ui32, name = #handshake.name<"fork5">} : i6
    %32 = oehb [4004] %31#0 {bb = 3 : ui32, name = #handshake.name<"oehb0">} : i6
    ...
    %36 = oehb [4008] %46#3 {bb = 3 : ui32, name = #handshake.name<"oehb6">} : i1
    %37 = mux %36 [%trueResult_9, %24] {bb = 3 : ui32, name = #handshake.name<"mux4">} : i1, i32
    %38 = mux %46#0 [%trueResult_11, %26] {bb = 3 : ui32, name = #handshake.name<"mux11">} : i1, i6
    %39:2 = fork [2] %38 {bb = 3 : ui32, name = #handshake.name<"fork6">} : i6
    %40 = arith.extsi %39#1 {bb = 3 : ui32, name = #handshake.name<"extsi17">} : i6 to i12
    %41 = mux %46#1 [%trueResult_13, %28] {bb = 3 : ui32, name = #handshake.name<"mux12">} : i1, i6
    ...
    %58 = arith.addi %33, %57 {bb = 3 : ui32, name = #handshake.name<"addi7">} : i13
    ...
    %60 = arith.muli %35, %52 {bb = 3 : ui32, name = #handshake.name<"muli5">} : i12
    %61 = arith.extsi %60 {bb = 3 : ui32, name = #handshake.name<"extsi25">} : i12 to i13
    %62 = oehb [4003] %45 {bb = 3 : ui32, name = #handshake.name<"oehb4">} : i13
    ...
    %74 = arith.cmpi ult, %70#1, %51 {bb = 3 : ui32, name = #handshake.name<"cmpi3">} : i7
    ...
    %trueResult_13, %falseResult_14 = cond_br %77#2, %44#0 {bb = 3 : ui32, name = #handshake.name<"cond_br2">} : i6
