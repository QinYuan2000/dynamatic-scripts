module {
  handshake.func @iir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: i32, %arg3: i32, %arg4: none, ...) -> i32 attributes {argNames = ["y", "x", "a", "b", "start"], resNames = ["out0"]} {
    ...
    %19 = tehb [3001] %27#3 {bb = 1 : ui32, name = #handshake.name<"tehb8">} : i1
    ...
    %29 = tehb [1] %28 {bb = 1 : ui32, name = #handshake.name<"tehb7">} : none
    ...
    %44 = tehb [1] %43 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : i32
    %addressResult_4, %dataResult_5 = mc_store[%44] %42#1 {bb = 1 : ui32, name = #handshake.name<"mc_store0">} : i32, i32
    %45 = tehb [3001] %16 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i12
    %46 = arith.addi %45, %38 {bb = 1 : ui32, name = #handshake.name<"addi2">} : i12
    ...
    %52 = tehb [3001] %23#0 {bb = 1 : ui32, name = #handshake.name<"tehb5">} : i32
    ...
    %53 = tehb [3001] %26#0 {bb = 1 : ui32, name = #handshake.name<"tehb6">} : i32
