module {
  handshake.func @iir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: i32, %arg3: i32, %arg4: none, ...) -> i32 attributes {argNames = ["y", "x", "a", "b", "start"], resNames = ["out0"]} {
    ...
    %11 = tehb [3001] %19#3 {bb = 1 : ui32, name = #handshake.name<"tehb8">} : i1
    ...
    %21 = tehb [1] %20 {bb = 1 : ui32, name = #handshake.name<"tehb7">} : none
    ...
    %37 = tehb [3001] %8 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i12
    %38 = arith.addi %37, %30 {bb = 1 : ui32, name = #handshake.name<"addi2">} : i12
    ...
    %44 = tehb [3001] %15#0 {bb = 1 : ui32, name = #handshake.name<"tehb5">} : i32
    ...
    %45 = tehb [3001] %18#0 {bb = 1 : ui32, name = #handshake.name<"tehb6">} : i32
