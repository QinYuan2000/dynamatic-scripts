module {
  handshake.func @sumi3_mem(%arg0: memref<1000xi32>, %arg1: none, ...) -> i32 attributes {argNames = ["a", "start"], resNames = ["out0"]} {
    ...
    %13 = oehb [4008] %15#1 {bb = 1 : ui32, name = #handshake.name<"oehb2">} : i1
    ...
    %24 = oehb [4004] %22#0 {bb = 1 : ui32, name = #handshake.name<"oehb3">} : i32
    ...
    %31 = tehb [1] %30 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i12
    ...
    %36 = oehb [4008] %35#1 {bb = 1 : ui32, name = #handshake.name<"oehb5">} : i1
