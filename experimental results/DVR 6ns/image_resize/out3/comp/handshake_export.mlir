module {
  handshake.func @image_resize(%arg0: memref<900xi32>, %arg1: i32, %arg2: none, ...) -> none attributes {argNames = ["a", "c", "start"], resNames = ["out0"]} {
    %memOutputs, %done = mem_controller[%arg0 : memref<900xi32>] (%29, %addressResult, %addressResult_2, %dataResult_3) {connectedBlocks = [2 : i32], name = #handshake.name<"mem_controller0">} : (i32, i32, i32, i32) -> (i32, none)
    ...
    %25 = oehb [1] %result_0 {bb = 2 : ui32, name = #handshake.name<"oehb6">} : none
    %26 = tehb [1] %25 {bb = 2 : ui32, name = #handshake.name<"tehb3">} : none
    ...
    %56 = oehb [1] %35 {bb = 2 : ui32, name = #handshake.name<"oehb7">} : i7
    %57 = tehb [1] %56 {bb = 2 : ui32, name = #handshake.name<"tehb4">} : i7
    %58 = arith.cmpi ult, %54#1, %57 {bb = 2 : ui32, name = #handshake.name<"cmpi2">} : i7
    %59:4 = fork [4] %58 {bb = 2 : ui32, name = #handshake.name<"fork10">} : i1
    %trueResult, %falseResult = cond_br %59#0, %55 {bb = 2 : ui32, name = #handshake.name<"cond_br0">} : i6
    sink %falseResult {name = #handshake.name<"sink0">} : i6
    %trueResult_4, %falseResult_5 = cond_br %59#2, %19#0 {bb = 2 : ui32, name = #handshake.name<"cond_br3">} : i32
    %60 = oehb [1] %21#0 {bb = 2 : ui32, name = #handshake.name<"oehb5">} : i6
    %61 = tehb [1] %60 {bb = 2 : ui32, name = #handshake.name<"tehb2">} : i6
    %trueResult_6, %falseResult_7 = cond_br %59#1, %61 {bb = 2 : ui32, name = #handshake.name<"cond_br1">} : i6
    %trueResult_8, %falseResult_9 = cond_br %59#3, %27#0 {bb = 2 : ui32, name = #handshake.name<"cond_br5">} : none
