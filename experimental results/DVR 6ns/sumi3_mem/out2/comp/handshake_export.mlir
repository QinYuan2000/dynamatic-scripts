module {
  handshake.func @sumi3_mem(%arg0: memref<1000xi32>, %arg1: none, ...) -> i32 attributes {argNames = ["a", "start"], resNames = ["out0"]} {
    ...
    %9 = tehb [2008] %11#1 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : i1
    ...
    %20 = tehb [2004] %18#0 {bb = 1 : ui32, name = #handshake.name<"tehb3">} : i32
    ...
    %26 = oehb [1] %25 {bb = 1 : ui32, name = #handshake.name<"oehb2">} : i12
    %27 = tehb [1] %26 {bb = 1 : ui32, name = #handshake.name<"tehb4">} : i12
    ...
    %32 = tehb [2008] %31#1 {bb = 1 : ui32, name = #handshake.name<"tehb5">} : i1
