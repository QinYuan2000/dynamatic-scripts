module {
  handshake.func @matrix(%arg0: memref<900xi32>, %arg1: memref<900xi32>, %arg2: memref<900xi32>, %arg3: none, ...) -> none attributes {argNames = ["inA", "inB", "outC", "start"], resNames = ["out0"]} {
    ...
    %19 = mux %34#2 [%trueResult, %14] {bb = 3 : ui32, name = #handshake.name<"mux10">} : i1, i6
    %20:3 = fork [3] %19 {bb = 3 : ui32, name = #handshake.name<"fork5">} : i6
    %21 = arith.extsi %20#0 {bb = 3 : ui32, name = #handshake.name<"extsi14">} : i6 to i13
    %22 = arith.extsi %20#1 {bb = 3 : ui32, name = #handshake.name<"extsi15">} : i6 to i7
    %23 = arith.extsi %20#2 {bb = 3 : ui32, name = #handshake.name<"extsi16">} : i6 to i12
    %24 = oehb [4008] %34#3 {bb = 3 : ui32, name = #handshake.name<"oehb6">} : i1
    %25 = mux %24 [%trueResult_9, %16] {bb = 3 : ui32, name = #handshake.name<"mux4">} : i1, i32
    %26 = mux %34#0 [%trueResult_11, %17] {bb = 3 : ui32, name = #handshake.name<"mux11">} : i1, i6
    %27:2 = fork [2] %26 {bb = 3 : ui32, name = #handshake.name<"fork6">} : i6
    %28 = arith.extsi %27#1 {bb = 3 : ui32, name = #handshake.name<"extsi17">} : i6 to i12
    %29 = mux %34#1 [%trueResult_13, %18] {bb = 3 : ui32, name = #handshake.name<"mux12">} : i1, i6
    %30 = oehb [1] %29 {bb = 3 : ui32, name = #handshake.name<"oehb3">} : i6
    %31 = tehb [1] %30 {bb = 3 : ui32, name = #handshake.name<"tehb6">} : i6
    %32:2 = fork [2] %31 {bb = 3 : ui32, name = #handshake.name<"fork7">} : i6
    %33 = arith.extsi %32#1 {bb = 3 : ui32, name = #handshake.name<"extsi18">} : i6 to i13
    %result_5, %index_6 = control_merge %trueResult_15, %11#1 {bb = 3 : ui32, name = #handshake.name<"control_merge8">} : none, i1
    %34:4 = fork [4] %index_6 {bb = 3 : ui32, name = #handshake.name<"fork8">} : i1
    %35 = source {bb = 3 : ui32, name = #handshake.name<"source0">}
    %36 = constant %35 {bb = 3 : ui32, name = #handshake.name<"constant14">, value = 30 : i6} : i6
    %37:3 = fork [3] %36 {bb = 3 : ui32, name = #handshake.name<"fork9">} : i6
    %38 = arith.extsi %37#0 {bb = 3 : ui32, name = #handshake.name<"extsi19">} : i6 to i12
    %39 = arith.extsi %37#1 {bb = 3 : ui32, name = #handshake.name<"extsi20">} : i6 to i7
    %40 = arith.extsi %37#2 {bb = 3 : ui32, name = #handshake.name<"extsi21">} : i6 to i12
    %41 = source {bb = 3 : ui32, name = #handshake.name<"source1">}
    %42 = constant %41 {bb = 3 : ui32, name = #handshake.name<"constant15">, value = 1 : i2} : i2
    %43 = arith.extsi %42 {bb = 3 : ui32, name = #handshake.name<"extsi22">} : i2 to i7
    %44 = arith.muli %28, %38 {bb = 3 : ui32, name = #handshake.name<"muli4">} : i12
    %45 = arith.extsi %44 {bb = 3 : ui32, name = #handshake.name<"extsi23">} : i12 to i13
    %46 = oehb [4004] %21 {bb = 3 : ui32, name = #handshake.name<"oehb0">} : i13
    %47 = arith.addi %46, %45 {bb = 3 : ui32, name = #handshake.name<"addi7">} : i13
    ...
    %49 = arith.muli %23, %40 {bb = 3 : ui32, name = #handshake.name<"muli5">} : i12
    %50 = arith.extsi %49 {bb = 3 : ui32, name = #handshake.name<"extsi25">} : i12 to i13
    %51 = oehb [4003] %33 {bb = 3 : ui32, name = #handshake.name<"oehb4">} : i13
    ...
    %63 = arith.cmpi ult, %59#1, %39 {bb = 3 : ui32, name = #handshake.name<"cmpi3">} : i7
    ...
    %68 = oehb [1] %27#0 {bb = 3 : ui32, name = #handshake.name<"oehb2">} : i6
    ...
    %trueResult_13, %falseResult_14 = cond_br %66#2, %32#0 {bb = 3 : ui32, name = #handshake.name<"cond_br2">} : i6
