module {
  handshake.func @fir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: none, ...) -> i32 attributes {argNames = ["di", "idx", "start"], resNames = ["out0"]} {
    ...
    %5 = oehb [1] %trueResult {bb = 1 : ui32, name = #handshake.name<"oehb3">} : i11
    %6 = tehb [1] %5 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : i11
    ...
    %12 = oehb [4004] %16#1 {bb = 1 : ui32, name = #handshake.name<"oehb1">} : i1
    %13 = mux %12 [%trueResult_4, %4] {bb = 1 : ui32, name = #handshake.name<"mux1">} : i1, i32
    %14 = oehb [1] %trueResult_6 {bb = 1 : ui32, name = #handshake.name<"oehb4">} : none
    %15 = tehb [1] %14 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : none
    ...
    %37 = oehb [4005] %36#1 {bb = 1 : ui32, name = #handshake.name<"oehb2">} : i1
