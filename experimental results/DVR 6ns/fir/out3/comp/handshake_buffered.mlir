module {
  handshake.func @fir(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: none, ...) -> i32 attributes {argNames = ["di", "idx", "start"], resNames = ["out0"]} {
    ...
    %9 = oehb [1] %trueResult {bb = 1 : ui32, name = #handshake.name<"oehb3">} : i11
    %10 = tehb [1] %9 {bb = 1 : ui32, name = #handshake.name<"tehb1">} : i11
    ...
    %16 = oehb [4004] %20#1 {bb = 1 : ui32, name = #handshake.name<"oehb1">} : i1
    %17 = mux %16 [%trueResult_4, %7] {bb = 1 : ui32, name = #handshake.name<"mux1">} : i1, i32
    %18 = oehb [1] %trueResult_6 {bb = 1 : ui32, name = #handshake.name<"oehb4">} : none
    %19 = tehb [1] %18 {bb = 1 : ui32, name = #handshake.name<"tehb2">} : none
    ...
    %41 = oehb [4005] %40#1 {bb = 1 : ui32, name = #handshake.name<"oehb2">} : i1
